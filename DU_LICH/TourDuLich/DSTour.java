...
public class DSTour {
    ...
    // 4. CHỈNH SỬA TOUR - KHÔNG ĐƯỢC ĐỔI MÃ TOUR (dùng loai() thay vì instanceof)
    public void chinhSuaTour(String maTour) {
        ...
        Tour tour = timTheoMa(maTour);  // Dùng hàm tìm sẵn có
        if (tour == null) {
            System.out.println("Khong tim thay tour voi ma " + maTour);
            return;
        }

        System.out.println("=== CHINH SUA TOUR (Ma tour giu nguyen: " + maTour + ") ===");
